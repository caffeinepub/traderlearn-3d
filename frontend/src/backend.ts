...
export class Backend implements backendInterface {
    ...
    async getAllModuleProgress(): Promise<Array<[string, boolean]>> {
    ...
    async isModuleComplete(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isModuleComplete(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markModuleComplete(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markModuleComplete(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetModule(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetModule(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
